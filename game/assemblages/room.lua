...
function Room.ground(e, w, h)
	...
	:give("pos", vec2(left_wall_w, h - ground_h))
	:give("collider", vec2(w - left_wall_w - right_wall_w, ground_h))
	:give("bump")
	:give("ground")
end
...
function Room.left_bound(e, w, h)
	...
	:give("pos", vec2())
	:give("collider", vec2(left_wall_w, h))
	:give("bump")
	:give("wall")
end
...
function Room.right_bound(e, w, h)
	...
	:give("pos", vec2(w - right_wall_w, 0))
	:give("collider", vec2(right_wall_w, h))
	:give("bump")
	:give("wall")
end
