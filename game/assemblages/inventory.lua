...
function Inventory.choice(e, str, x, y)
	...
	:give("transform", 0.1745329, vec2(1, 1), vec2(0.5, 0.5), vec2(-0.25, 0))
	:give("ui_element")
end
...
function Inventory.border(e, i, x, y, rw, rh, ih, is_horizontal)
	...
	:give("pos", vec2(x, y))
	:give("transform", r, vec2(0.5, sy), vec2(0.5, 0), vec2(-0.05, -0.05))
	:give("textured_line")
	:give("ui_element")
	:give("color", {1, 1, 1, 1})
end
...
function Inventory.dline(e, i, x1, y1, x2, y2)
	...
	:give("sprite", "inventory_border")
	:give("pos", vec2(x1, y1))
	:give("transform", r, vec2(0.25, 1), vec2(0.5, 0), vec2(0.05, 0.05))
	:give("textured_line")
	:give("ui_element")
	:give("color", {1, 1, 1, 1})
end
