...
function Office2:state_setup()
	local w, h = Resources.data.images.office2:getDimensions()
	...
	self.world:emit("create_room_bounds", rw, h, { room_id = Enums.game_state.Office2, sx = mult })
	...
	self.world:emit("set_ambiance", Palette.get_diffuse("ambiance_office2"))
